"""
URL configuration for myntraproject project.
...
urlpatterns = [
    ...
    path('glasslist/',views.glasslist,name='glasslist'),
    path('shoeslist/',views.shoeslist,name='shoeslist'),
    path('clotlist/',views.clothlist,name='clothlist'),
    ...
    path('serchproducts/',views.serchproducts,name='serchproducts'),
